...
| Temperature-dependent MICP | `10.1007/s11440-022-01664-9` | Journal DOI expuesto en la landing pública del preprint; buen apoyo para exposición ambiental y cinética citeturn54view1 |
| Recent environmental optimization paper | `10.1061/JGGEFK/GTENG-12230` | Journal DOI expuesto en la landing pública del preprint; útil para jerarquizar drivers ambientales citeturn56view0 |
| On-site bacteria influence paper | `10.1061/JGGEFK/GTENG-12338` | Journal DOI expuesto en la landing pública del preprint; muy útil para argumentar dependencia de sitio y pH citeturn53view3 |

Mi recomendación editorial final es esta: en el suplemento no presentes una sola “tabla de validación”, sino una **tabla de trazabilidad parámetro–dataset–alcance**. Eso permite decir, con honestidad y precisión, qué queda **calibrado**, qué queda **acotado**, qué solo queda **sensibilizado**, y qué sigue **no identificado**. Esa estructura es la que mejor responde a la objeción del AE sin fingir que ya existe una validación directa de zapatas MICP degradadas que, al menos en la búsqueda pública hecha aquí, no apareció. fileciteturn0file0